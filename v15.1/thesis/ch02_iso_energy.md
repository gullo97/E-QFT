...
>
> **[Postulate K2 — nearest neighbour].** The elementary step is $\Delta n = \pm 1$. (Motivation: any $\Delta n = \pm k$ step telescopes *kinematically* into $k$ elementary ones — Chapter 3 proves the bare composition is exact. But physical amplitudes do not compose the same way once other particles are present — Ch. 3.7's slogan is "kinematics telescopes, dynamics remembers" — so K2 is more than a labeling convention: its genuine dynamical content is that no irreducible long jumps exist.)
