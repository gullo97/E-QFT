...
Pi = Pi0 + kappa q^2.  Verdict sought: kappa_TT+ = kappa_TTx (the graviton),
kappa_conf opposite sign (DeWitt signature), diffeo control ~ 0.

[ARCHIVE NOTE, 2026-08: superseded by scripts/ch25_graviton.py.  In this exp(-s w)
scheme kappa_TT comes out NEGATIVE and kappa_conf positive (the original ">0"
verdict line above was wrong for this scheme); the overall sign is regulator-
scheme-dependent — see the sign audit in thesis Ch. 25.5.]
"""
import json
import numpy as np
import matplotlib
